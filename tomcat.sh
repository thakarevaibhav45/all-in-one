...
sed -i '56  s/</tomcat-users>/<role rolename="manager-gui"/g>' apache-tomcat-9.0.83/conf/tomcat-users.xml > apache-tomcat-9.0.83/conf/tomcat-users.xml
sed -i '57  a\<role rolename="manager-script"/>' apache-tomcat-9.0.83/conf/tomcat-users.xml
sed -i '58  a\<user username="tomcat" password="tomcat" roles="manager-gui, manager-script"/>' apache-tomcat-9.0.83/conf/tomcat-users.xml
